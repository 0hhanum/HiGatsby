...
type getContensQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly excerpt: string | null, readonly frontmatter: { readonly author: string | null, readonly title: string | null, readonly category: string | null } | null }> } };
